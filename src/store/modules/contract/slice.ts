...
const setContractsListAction = createAction<ContractListType, 'setContractsList'>('setContractsList')
const setListLoadingAction = createAction<boolean, 'setListLoading'>('setListLoading')
...
const contractSlice = createSlice({
  ...
  reducers: {
    ...
    [setContractsListAction.type]: (state: Draft<ContractState>, action: PayloadAction<ContractListType>) => {
      state.contracts = action.payload
    },
    [setListLoadingAction.type]: (state: Draft<ContractState>, actions: PayloadAction<boolean>) => {
      state.isListLoading = actions.payload
    }
  },
});

export const { setInitedContract, setScreenData, setFieldError, clearErrors, setContractsList, setListLoading} =
