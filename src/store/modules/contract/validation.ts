...
import {
  ...
  CONFIRMATION_FIELDS,
  PAYMENT_FIELDS, PAYMENT_METHODS
} from "./types";
import {
  length,
...
export const contractValidationConfig = {
  [CONTRACT_TYPES.PURCHASE]: {
    ...
    [CONTRACT_SCREEN_TYPES.PRODUCT_DATA]: {
      ...
      [PRODUCT_DATA_FIELDS.serial]: [lengthCheckIfAnotherFieldIsTrue('contracts.validation.field_empty', 1, PRODUCT_DATA_FIELDS.isSerial)]
    },
    [CONTRACT_SCREEN_TYPES.PRODUCT_CONDITION]: {
      [PRODUCT_CONDITION_FIELD_NAME]: [length('contracts.validation.field_empty', 1)]
    },
    [CONTRACT_SCREEN_TYPES.PRODUCT_DESCRIPTION]: {
      [PRODUCT_DESCRIPTION_FIELDS.description]: [length('contracts.validation.field_empty', 1)],
      [PRODUCT_DESCRIPTION_FIELDS.descriptionAccessories]: [lengthCheckIfAnotherFieldIsTrue('contracts.validation.field_empty', 1, PRODUCT_DESCRIPTION_FIELDS.hasAccessories)]
    },
    [CONTRACT_SCREEN_TYPES.CONFIRMATION]: {
      [CONFIRMATION_FIELDS.FIRST]: [length('contracts.validation.field_empty', 1)],
      [CONFIRMATION_FIELDS.SECOND]: [length('contracts.validation.field_empty', 1)]
    },
    [CONTRACT_SCREEN_TYPES.PAYMENT]: {
      [PAYMENT_FIELDS.COST]: [length('contracts.validation.field_empty', 1)],
      [PAYMENT_FIELDS.PAYMENT_METHOD]: [length('contracts.validation.field_empty', 1)],
      [PAYMENT_FIELDS.CARD_NAME]: [lengthCheckIfAnotherFieldHasSpecificValue('contracts.validation.field_empty', 1, PAYMENT_FIELDS.PAYMENT_METHOD, PAYMENT_METHODS.TRANSFER)],
      [PAYMENT_FIELDS.CARD_NUMBER]: [lengthCheckIfAnotherFieldHasSpecificValue('contracts.validation.field_empty', 1, PAYMENT_FIELDS.PAYMENT_METHOD, PAYMENT_METHODS.TRANSFER)]
    },
