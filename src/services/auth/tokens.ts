...
import {TOKEN_REFRESH_STORAGE_KEY, TOKEN_STORAGE_KEY} from "../../store/modules/auth/constants";
...
export const getAuthTokens = async (): Promise<{token: string | null, refresh: string | null}> => {
    return {
