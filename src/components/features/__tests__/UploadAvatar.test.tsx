...
jest.mock('../../components/UserAvatar', () => {
    ...
    return (props: any) => React.createElement('Text', {...props, testID: 'testID'})
})

jest.mock('../../features/Modals/Menu', () => {
    const React = require('react')
    return (props: any) => React.createElement('Text', {...props, testID: 'MenuTestID'})
})

jest.mock('../../../services/media/media-picker', () => ({
    cameraWay: jest.fn().mockImplementation(() => new Promise(resolve => resolve('cameraurl'))),
    libraryWay: jest.fn()
}))
// @ts-ignore
libraryWay.mockImplementationOnce(() => new Promise(resolve => resolve('libraryurl')))
    .mockImplementationOnce(() => new Promise((resolve, reject) => reject('test.message')))
    .mockImplementationOnce(() => {throw new PermissionNotGranted('test.message')})
...
describe('UploadAvatar', () => {
    it('Should display user avatar and menu', () => {
        ...
        expect(getByTestId('testID').props.url).toEqual(initialState.profile.user.avatar)
    ...
    it('Should open menu', () => {
        ...
        getByTestId('MenuTestID').props.buttons.forEach((button: any, index: number) => {
