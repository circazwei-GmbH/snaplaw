...
describe('ProductCondition', () => {
    it('Should dispaly all checkboxes', () => {
        ...
        CONDITIONS.forEach(condition => {
            expect(getByText(`contracts.${CONTRACT_TYPES.PURCHASE}.${CONTRACT_SCREEN_TYPES.PRODUCT_CONDITION}.checkboxes.${condition}`)).toBeTruthy()
        })
    })
    it('Should call handler', () => {
        ...
        CONDITIONS.forEach(condition => {
            fireEvent.press(getByText(`contracts.${CONTRACT_TYPES.PURCHASE}.${CONTRACT_SCREEN_TYPES.PRODUCT_CONDITION}.checkboxes.${condition}`))
            expect(actions).toBeCalledWith(setScreenData({
