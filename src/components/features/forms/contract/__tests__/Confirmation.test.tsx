...
describe('Confirmation', () => {
    it('Should display all checkboxes', () => {
        ...
        CONFIRMATION.forEach(confirmation => {
            expect(getByText(`contracts.${CONTRACT_TYPES.PURCHASE}.${CONTRACT_SCREEN_TYPES.CONFIRMATION}.confirmation.${confirmation}`)).toBeTruthy()
        })
    })
    it('Should dispatch action on check', () => {
        ...
        CONFIRMATION.forEach(confirmation => {
            fireEvent.press(getByText(`contracts.${CONTRACT_TYPES.PURCHASE}.${CONTRACT_SCREEN_TYPES.CONFIRMATION}.confirmation.${confirmation}`))
