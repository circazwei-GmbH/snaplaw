...
export default function Sign() {
    ...
    const signModalHandler = () => {
        ...
        dispatch(orientationChange(!signVisible ? OrientationLock.LANDSCAPE_RIGHT : OrientationLock.PORTRAIT))
    }
    ...
    return (
        <View style={styles.container}>
            <View style={styles.block}>
                ...
                <SignInput style={styles.inputInBlock} signUri={undefined} signHandler={signModalHandler} />
            </View>
            <View style={styles.block}>
