          ...
          <Pressable style={styles.filtersModalContainer}>
            <View>
              <Text style={styles.title}>
                {t("my_contracts.smart_filters.modal_name")}
              </Text>
              <Text style={styles.subtitle}>
                {t("my_contracts.smart_filters.modal_subtitle")}
              </Text>

              <View style={styles.filtersformContainer}>
                <View style={styles.filtersformTopBar}>
                  <Text style={styles.containersTitle}>
                    {t("my_contracts.smart_filters.categories")}
                  </Text>
                  <TextButton
                ...
                <View style={styles.dateContainer}>
                  <Text style={styles.containersTitle}>
                    {t("my_contracts.smart_filters.by_date")}
                  </Text>
