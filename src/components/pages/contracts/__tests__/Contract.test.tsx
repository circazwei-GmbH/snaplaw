...
jest.mock('../../../../store/modules/contract/contract-screens-types', () => {
    const { CONTRACT_TYPES } = require('../../../../store/modules/contract/constants')
...
describe('Contract', () => {
    it('Should display form component', () => {
        ...
        expect(getByText(`contracts.${CONTRACT_TYPES.PURCHASE}.title`)).toBeTruthy()
    ...
    it('Should call navigation on navigate next', () => {
        ...
        expect(useNavigation().push).toBeCalledWith(HOME_ROUTER.CONTRACT, {screenCount: 1})
    })
