...
describe("ChangePassword", () => {
  it("Should display fields", () => {
    ...
    expect(
      getByPlaceholderText("change_password.fields.new_password")
    ).toBeTruthy();
    expect(getByText("change_password.description")).toBeTruthy();
    expect(
      getByPlaceholderText("change_password.fields.confirm_password")
    ).toBeTruthy();
  ...
  it("Should validate empty and less then 6 chars", () => {
    ...
    expect(getAllByText("change_password.errors.password_length")).toHaveLength(
      2
    );
  });
  it("Should validate field matching", () => {
    ...
    expect(
      queryByText("change_password.errors.confirm_password")
    ).not.toBeTruthy();
  });
