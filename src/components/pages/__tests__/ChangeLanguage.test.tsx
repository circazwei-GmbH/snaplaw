...
describe("ChangeLanguage", () => {
    ...
    it('Should dispatch on press', () => {
        ...
        fireEvent(getByTestId('Switch.change_language.languages.germany'), 'onValueChange', 1)

        expect(actionType).toBeCalledWith(setLanguage(LANGUAGE_GERMANY))

        fireEvent(getByTestId('Switch.change_language.languages.english'), 'onValueChange', 1)
